...
$sql = "INSERT INTO talent_photogarphy (employee_id,name,type,exp,price,img1,img2,img3,img4,img5,img6)
 VALUES ('$emp','$name','$type','$exp','$price','$p1','$p2','$p3','$p4','$p5','$p6')";
            ...
            <form  method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="full name of studio">                
                    </div>
                </div>

                <div class="form-group">
                    <label>Type of Photgraphy:</label>
                    <div class="input-group">
