...
$no =  $_SESSION['no'];
echo $no;
$sql="SELECT employee_id FROM employees WHERE number = '$no'";
...
$sql = "INSERT INTO talent_singing (employee_id,name,type,exp,grp,price,img1,img2,img3,img4,img5,img6)
 VALUES ('$emp','$name','$type','$exp','$grp','$price','$p1','$p2','$p3','$p4','$p5','$p6')";
            ...
            <form  method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Ex rock dj">                
                    </div>
                </div>

                <div class="form-group">
                    <label>Type of Singing:</label>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                        <input type="text" name="type" class="form-control" placeholder="Ex Classical, rock."> 
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="exp" class="form-control">
							...
							<option value='3'>Above 3 year</option>
						</select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                        <input type="number" name="price" class="form-control" placeholder="In Ruppees">
                        <select name="grp" class="form-control">
