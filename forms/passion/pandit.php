...
$sql = "INSERT INTO passion_pandit (employee_id,type,exp,price,img1,img2,img3,img4,img5,img6)
        ...
        <div class="container" style="padding: 50px 200px 50px 200px;" class="text-center" >
            ...
            <form  method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Type of pandit:</label>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                        <input type="text" name="type" class="form-control" placeholder="enter your role as pandit">                
                    </div>
                </div>
